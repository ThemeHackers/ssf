...
class BruteScanner(BaseScanner):
    ...
    def _load_wordlist(self) -> List[str]:
        path = "scanners/table_lists.txt"
        if self.wordlist_path and self.wordlist_path != "default":
        ...
        try:
            ...
            self.log_warn(f"Wordlist not found at {path}, falling back to default list.")
